...
class PhotoViewerDialog(QDialog):
    def __init__(self, photo_path, parent=None):
        ...
        max_width = 800  # 设置您期望的最大宽度
        max_height = 800  # 设置您期望的最大高度
...
class TCPClient(QWidget):
    ...
    def show_photo_viewer(self):
        photo_path = 'ITF_Team_Photo.jpg'  # 替换为你的照片文件路径
        viewer_dialog = PhotoViewerDialog(photo_path, self)
        viewer_dialog.exec_()

if __name__ == '__main__':
    app = QApplication(sys.argv)

    app_icon = QIcon('tool_icon.png')  # 替换icon.png为您的图标文件名
