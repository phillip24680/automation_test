...
class MyWindow(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('ITF Commander')
        self.resize(700, 700)
        ...
        # 创建界面组件 -- 标题栏
        self.header_label = QLabel('                                    ITF Commander                           V1.0')
        ...
        self.header_label.setFixedHeight(40)  # 设置高度为40像素
        ...
        #self.start_button.setStyleSheet("background-color: #daf1f5;")
        self.start_button.setFont(QFont('Microsoft YaHei', 10))  # 设置字体大小
        self.clear_button = QPushButton('Clear', self)
        # self.start_button.setStyleSheet("background-color: #daf1f5;")
        self.clear_button.setFont(QFont('Microsoft YaHei', 10))  # 设置字体大小

        self.Startup_layout.addWidget(self.start_button)
        self.Startup_layout.addWidget(self.clear_button)

        self.start_button.clicked.connect(self.start_connection)
        self.clear_button.clicked.connect(self.clear_test_result)
        self.layout.addLayout(self.Startup_layout)
        ...
        self.short_button = QPushButton('Button: Short Press', self)
        ...
        self.long_button = QPushButton('Button: Long Press', self)
        ...
        self.rgb_button_red = QPushButton('LED: Red Color Check', self)
        ...
        self.module_layouts.append(red_layout)
        ...
        self.rgb_button_green = QPushButton('LED: Green Color Check', self)
        ...
        self.module_layouts.append(green_layout)
        ...
        self.rgb_button_blue = QPushButton('LED: Blue Color Check', self)
        ...
        self.module_layouts.append(blue_layout)
    ...
    def clear_test_result(self):
        ...
        self.ITFversion_button.setEnabled(True)
        self.sequence_button_ITFversion.setEnabled(True)
        self.sequence_button_red.setEnabled(True)
        self.rgb_button_red.setEnabled(True)
        self.sequence_button_green.setEnabled(True)
        self.rgb_button_green.setEnabled(True)
        self.sequence_button_blue.setEnabled(True)
        self.rgb_button_blue.setEnabled(True)
        self.sequence_button_short.setEnabled(True)
        self.short_button.setEnabled(True)
        self.sequence_button_long.setEnabled(True)
        self.long_button.setEnabled(True)
        self.sequence_button_wifi.setEnabled(True)
        self.wifi_button.setEnabled(True)
        self.sequence_button_zigbeeVersion.setEnabled(True)
        self.zigbeeVersion_button.setEnabled(True)
        self.sequence_button_zigbee.setEnabled(True)
        self.zigbee_button.setEnabled(True)
        self.sequence_button_modbus.setEnabled(True)
        self.modbus_button.setEnabled(True)
        self.ITFversion_pass_label.setText('')  # 清除标签名称
        self.ITFversion_content_label.setText('')  # 清除标签名称
        self.ITFversion_pass_label.setText('')  # 清除标签名称
        self.short_pass_label.setText('') # 清除标签名称
        self.long_pass_label.setText('')  # 清除标签名称
        self.rgb_pass_label_red.setText('')
        self.rgb_pass_label_green.setText('')
        self.rgb_pass_label_blue.setText('')
        self.wifi_pass_label.setText('')
        self.zigbeeVersion_pass_label.setText('')
        self.zigbee_pass_label.setText('')
        self.zigbeeVersion_content_label.setText('')
        self.modbus_pass_label.setText('')
        ...
        #self.ITFversion_pass_label.setStyleSheet(self.original_style_sheet_red)  # 恢复原始样式表
